# 🏦 Sistema Integrado de Cálculo de Investimento
 
## 📝 Descrição do Projeto
Este sistema é uma solução completa de análise numérica aplicada ao mercado financeiro. Ele integra os métodos de **Regra do Trapézio** e **Regra de Simpson 1/3** para calcular o montante final de investimentos sob capitalização contínua, permitindo que o usuário escolha a técnica de aproximação desejada ou compare os resultados entre elas.
...
* **Conceitos:** Modularização de Código, Integração Numérica Composta, UX via CLI (Command Line Interface).
 
## 📊 Resultados e Aprendizados
A criação deste sistema unificado consolidou conceitos importantes de arquitetura de software e matemática aplicada.
